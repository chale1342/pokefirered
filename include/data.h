...
// Follower Pokemon message pools (see src/data/text/follower_messages.h).
// Counts exclude the conditional messages appended at the end of each array,
// which the follower engine references by index.
