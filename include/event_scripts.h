...
// Follower Pokemon interaction scripts (data/scripts/follower.inc)
...
extern const u8 gText_FollowerLostInThought[];
extern const u8 gText_FollowerDefault[];
extern const u8 gText_WantsToFly[];

// Movements between these two labels won't hide the follower (data/scripts/movement.inc)
