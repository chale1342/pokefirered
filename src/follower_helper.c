...
const struct FollowerMsgInfoExtended gFollowerConditionalMessages[COND_MSG_COUNT] = {
    ...
    .conditions = {MATCH_MAP(INDIGO_PLATEAU_EXTERIOR)},
    },
    [COND_MSG_MT_EMBER] =
    {
    .text = sCondMsg07,
    .emotion = FOLLOWER_EMOTION_HAPPY,
    .conditions = {MATCH_MAPSEC(MAPSEC_MT_EMBER)},
    },
    [COND_MSG_DAY_CARE] =
    {
    .text = sCondMsg08,
    ...
    .conditions = {MATCH_MAP(POWER_PLANT)},
    },
    [COND_MSG_SAILING] =
    {
    .text = (u8*)sBoatTexts,
    ...
    .conditions = {MATCH_MUSIC(MUS_SS_ANNE)},
    },
    [COND_MSG_PUDDLE] =
    {
    .text = sCondMsg18,
    ...
    .text = sCondMsg19,
    .emotion = FOLLOWER_EMOTION_MUSIC,
    .conditions = {MATCH_ON_MB(MB_SAND, MB_SAND)},
    },
    [COND_MSG_GRASS] =
    {
    .text = sCondMsg20,
    ...
    .textSpread = 1,
    .emotion = FOLLOWER_EMOTION_SURPRISE,
    .conditions = {MATCH_MAPSEC(MAPSEC_ICEFALL_CAVE)},
    },
    [COND_MSG_FEAR] =
    {
    .text = (u8*)sFearTexts,
    ...
    .conditions = {
        ...
        MATCH_MAPSEC(MAPSEC_POKEMON_TOWER),
        MATCH_MUSIC(MUS_POKE_TOWER),
    }
    },
    [COND_MSG_FIRE_RAIN] =
    {
    ...
    .text = sCondMsg39,
    .emotion = FOLLOWER_EMOTION_PENSIVE,
    .conditions = {MATCH_MAPSEC(MAPSEC_VIRIDIAN_FOREST)},
    },
    [COND_MSG_ICE] =
    {
    .text = (u8*)sIceTexts,
