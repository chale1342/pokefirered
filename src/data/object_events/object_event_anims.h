...
// Animations for follower Pokemon sprite sheets, which have
// 2 frames per direction (face + walk) laid out as
// 0: face south, 1: go south, 2: face north, 3: go north, 4: face west, 5: go west
...
// Extra follower anim indices past the standard set.
// These belong in include/constants/event_object_movement.h next to
// ANIM_RAISE_HAND; defined here for now to keep changes local to this file.
