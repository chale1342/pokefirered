...
const struct WildPokemon sRoute10_FireRed_LandMons[] =
{
    ...
    { 14, 14, SPECIES_VOLTORB },
    { 13, 13, SPECIES_MAGNEMITE },
    { 14, 14, SPECIES_PIKACHU },
    { 17, 17, SPECIES_ELECTABUZZ },
};
