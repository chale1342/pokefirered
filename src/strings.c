...
const u8 gText_ViewPokemon[] = _("View POKéMON");
const u8 gText_AreaGuide[] = _("Area Guide");
const u8 gText_NoPokemonFound[] = _("No POKéMON found.");
const u8 gText_AreaPokemonControls[] = _("{DPAD_UPDOWN}SCROLL {B_BUTTON}BACK");
...
const u8 gText_ExpSharePartyModeOn[] = _("EXP. SHARE is now in PARTY mode!\nAll POKéMON will receive 50% EXP.");
const u8 gText_ExpSharePartyModeOff[] = _("EXP. SHARE PARTY mode turned off.\nUse as held item for 100% EXP.");
